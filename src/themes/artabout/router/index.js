...
const OrderAddress = () => import(/* webpackChunkName: "map" */ 'theme/pages/OrderAddress.vue')
const OrderShops = () => import(/* webpackChunkName: "map" */ 'theme/pages/OrderShops.vue')

let routes = [
  { name: 'home', path: '/', component: Home, alias: '/pwa.html', meta: {title: 'Αρχική', description: 'Χρήστος Γυράδικο'} },
  { name: 'checkout', path: '/checkout', component: Checkout },
  // { name: 'legal', path: '/legal', component: Static, props: {page: 'lorem', title: 'Legal Notice'}, meta: {title: 'Legal Notice', description: 'Legal Notice - example of description usage'} },
  { name: 'privacy', path: '/privacy', component: Static, props: {page: 'privacy', title: 'Πολιτική Απορρήτου'} },
  { name: 'shops', path: '/shops', component: Static, props: {page: 'shops', title: 'Καταστήματα'} },
  ...
  { name: 'terms-of-use', path: '/terms-of-use', component: Static, props: {page: 'terms-of-use', title: 'Όροι Χρήσης'} },
  ...
  { name: 'order', path: '/order', component: OrderAddress, meta: {title: 'Παραγγελία - Βάλτε την διεύθυνσή σας'} },
  { name: 'service', path: '/katastimata', component: OrderShops, props: true, meta: {title: 'Εξυπηρέτηση'} }
