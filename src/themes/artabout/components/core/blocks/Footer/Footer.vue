<template>
  <footer v-if="!isOrderS2" :class="{ 'brdr-top-1 brdr-cl-black': isCheckoutPage }">
    <!-- <newsletter class=" flex brdr-bottom-1 brdr-cl-secondary" v-if="!isCheckoutPage" /> -->
    <div class="footer-links flex pt30 pb60 px40 bg-cl-black" v-if="!isCheckoutPage">
      <div class="container">
        <div class="row m0 start-xs between-md">
          <!-- no-mobile -->
          <div
            class="row m0 col-lg-12 col-md-12 col-xs-8 start-md between-md between-xs between-lg"
          >
            <div class="start-md">
              <h3 class="cl-white weight-400">{{ $t('ΠΑΡΑΓΓΕΛΙΕΣ') }}</h3>
              <div class="mt15">
                <router-link
                  class="cl-white"
                  :to="'/my-account'"
                  exact
                >{{ $t('Ο λογαριασμός μου') }}</router-link>
              </div>
              <div class="mt15">
                <router-link
                  class="cl-white"
              ...
              <div class="mt15">
                <router-link
                  ...
                  :to="'/privacy'"
                  exact
                >{{ $t('Πολιτική Απορρήτου') }}</router-link>
              </div>
            </div>
            <div class="start-md">
              <h3 class="cl-white weight-400">{{ $t('ΚΑΤΑΣΤΗΜΑΤΑ') }}</h3>
              <div class="mt15">
                <h3 class="cl-white mb0">ΚΕΝΤΡΟ</h3>
                <div class="store-information">
                  <p class="cl-white m0 pt10">Εγνατίας 150, Κέντρο</p>
                  <p class="cl-white phone m0 pt10">2310.254.466</p>
                  <p class="cl-white phone m0 pt10">2310.254.469</p>
                  <p class="cl-white m0 pt10">Whats up!</p>
                  <p class="cl-white phone m0 pt10">6987.233.673</p>
                  <p class="cl-white m0 pt10">Vodafone</p>
                  <p class="cl-white phone m0 pt10">6940.704.911</p>
                </div>
              </div>
            </div>
            <div class="start-md">
              <span class="pt50 hidden-xs"></span>
              <div class="mt15 pt60">
                <h3 class="cl-white mb0">ΝΕΑΠΟΛΗ</h3>
                <div class="store-information">
                  <p class="cl-white m0 pt10">Ελευθερίου Βενιζέλου 56-58</p>
                  <p class="cl-white phone m0 pt10">2310.633.183</p>
                  <p class="cl-white phone m0 pt10">2310.633.185</p>
                  <p class="cl-white m0 pt10">Whats up!</p>
                  <p class="cl-white phone m0 pt10">6971.501.591</p>
                  <p class="cl-white m0 pt10">Vodafone</p>
                  <p class="cl-white phone m0 pt10">6940.706.073</p>
                </div>
              </div>
            </div>
            <div class="start-md">
              <h3 class="cl-white">ΑΚΟΛΟΥΘΗΣΤΕ ΜΑΣ</h3>
              <p class="cl-white mt15">Για να μην χάνετε ούτε μία προσφορά!</p>
              <a
              ...
              <!-- <p class="mt1 cl-white">Εγγραφή στο newsletter μας</p> -->
              <!-- <newsletter class=" flex brdr-bottom-1 brdr-cl-secondary" v-if="!isCheckoutPage" /> -->
            </div>
          </div>
        </div>
